...
ANALYSIS=${4:-kinship} # Type of analysis with pcangsd. It can be one of the following: pca, selection, inbreedSites, kinship, admix
...
if [ $ANALYSIS = pca ]; then
        ...
        pcangsd -beagle $BEAGLE -kinship -minMaf $MINMAF -threads 16 -o $BASEDIR'angsd/pcangsd_'$PREFIX
