...
BASEDIR=${2:-/projects/f_mlp195/kyraf/croaker/lcwgs/} # Path to the base directory where output files will be written to a subdirectory named "angsd/". An example for the Greenland cod data is: /workdir/cod/greenland-cod/
